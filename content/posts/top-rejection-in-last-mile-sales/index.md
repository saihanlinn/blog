...
Everywhere we went, the top rejection was always: “If there is proof, we will buy.”
...
**Q: What is the most common rejection faced when introducing a new product in rural Asian villages?**
A: The most common rejection is the demand for concrete proof: "If someone uses your product and we see proof that it works in our season and in our region, then we might buy it."

**Q: How can a new company with a highly limited budget afford demonstration plots?**
A: Instead of large, costly demonstration plots, sales representatives can negotiate small test plots. They can offer a strong discount for a fraction of an acre (e.g., 0.1 acre) to early adopters, creating initial proof without burning the budget.

**Q: Why are physical demonstrations considered the heart of a sales strategy in emerging markets?**
A: In last mile markets, selling is not about convincing with words but about showing proof. A single successful, visible demonstration can build trust, which is the ultimate currency, and permanently shift an entire village's purchasing behavior.

{{< figure src="29.jpeg" title="Top Rejection in Last Mile Sales" >}}
