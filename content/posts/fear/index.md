...
Before I left, I told everyone in the team group meeting that I would personally handle this case during the trip. I also asked one of his close colleagues to prepare a hotel room for me and to make initial contact with the local police station to open a case if needed.

Nothing dramatic. Nothing public.
...
There is no single formula. But one thing I’ve learned the hard way is this. If you say “zero tolerance,” you have to be prepared to walk the talk.
...
Care without boundaries creates chaos. Boundaries without care create resentment.

Managing the last mile means living in that tension, consistently. And over the years, I’ve learned that consistency matters far more than severity.

---

### Frequently Asked Questions

**Why does cash collection create friction in last-mile sales environments?**
In rural or frontier markets where digital banking infrastructure is absent, direct cash collection is unavoidable. This creates structural loopholes where physical distance from headquarters can give field staff the illusion that financial systems are weak, occasionally leading to withheld funds or intentional fraud.

**How should a sales leader enforce a 'zero tolerance' policy effectively?**
To be effective, zero tolerance requires believable presence rather than constant punishment. When leaders personally travel to the field to address breaches—rather than delegating exclusively to corporate teams—the sheer consistency of their boundary enforcement often resolves the issue before a formal confrontation even occurs.

**What is the correct balance between empathy and strict corporate boundaries in field sales?**
Last-mile management requires living in a delicate tension. Managers must demonstrate genuine care for the localized pressures and temptations their teams face, while maintaining absolute clarity that specific boundaries (like financial fraud) cannot be crossed. Care without boundaries triggers chaos, whereas extreme boundaries without empathy create resentment.

{{< figure src="21.png" title="Fear" >}}
